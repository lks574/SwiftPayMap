...
class CalenderView2: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
...
class dateCVCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        lbl.leftAnchor.constraint(equalTo: self.leftAnchor).isActive=true
        lbl.rightAnchor.constraint(equalTo: self.rightAnchor).isActive=true
